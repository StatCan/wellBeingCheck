      ...
      <PaperProvider theme={newTheme}>
        ...
        <Background>
          ...
          <View>
            ...
            {this.state.showThankYou && Alert.alert('',  this.state.thankYouText)
              // <View style={{ backgroundColor: 'black', width: '80%', position: 'absolute', zIndex: 29, alignSelf: 'center', top: '70%', justifyContent: 'center', alignItems: 'center' }}>
