...
class EQSurveyScreen extends React.Component<Props> {
  ...
  render() {
    ...
    if (global.debugMode) console.log("Debug Mode ON"); console.log("sacode:"+global.surveyACode);
    ...
    return (
          ...
          <View style={{ flex: 1, marginTop: 10 }}>
           ...
           <ScrollView style={{marginTop:75}} ref='_scrollView'   onContentSizeChange={() => {console.log("go here"); this.refs._scrollView.scrollTo({x: 0, y: 0, animated: true}); }}>
