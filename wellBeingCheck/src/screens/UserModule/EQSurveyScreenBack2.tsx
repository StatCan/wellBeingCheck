...
export default class EQSurveyScreen extends React.Component<Props, ScreenState> {
 ...
 //   let bbb='let logo = document.querySelector("#__btnPrevious");logo.addEventListener("click", addclick); function addclick(){setTimeout(function(){var el=document.querySelector("div.sc-progperc");el.scrollIntoView();let logo = document.querySelector("#__btnPrevious");logo.addEventListener("click", addclick); },1000)}';

   // let aaa='let logo = document.querySelector("#__btnNext");logo.addEventListener("click", addclick); function addclick(){setTimeout(function(){var el=document.querySelector("div.sc-progperc");el.scrollIntoView();let logo = document.querySelector("#__btnNext");logo.addEventListener("click", addclick); },1000)}';

   // let aaa='let logo = document.querySelector("#scSurveyBody");logo.addEventListener("change", (event) => {var el=document.querySelector("div.sc-progperc");el.scrollIntoView();alert("Logo has been loaded!"); });';
