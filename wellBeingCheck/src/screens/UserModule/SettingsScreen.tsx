...
//var hours = time[0] + time[1];
 ...
 // var min = time[3] + time[4];
  ...
  _changeLanguage(c) {
    ...
    console.log("Changing language to in change language: " + c,'Wake time=================',this.state.waketime);
          ...
          <View style={styles.containerStyle}>
            <ScrollView>
              <List.Section style={styles.mainStyle}>
                ...
                {
                     <Modal animationType="slide" transparent={true} visible={this.state.numPingsModalShow}
                           onRequestClose={() => { // Alert.alert("Modal has been closed.");
                                          }}>
                        <View style={{width:'80%',justifyContent:'center',backgroundColor:'white',alignSelf:'center',marginTop:140}}>
                                 <Text style={{fontSize:18,fontWeight:'bold',marginBottom:10}}>{resources.getString("num_pings_dialog_title")}</Text>
                                <RadioButton.Group
                                                        onValueChange={n => {
