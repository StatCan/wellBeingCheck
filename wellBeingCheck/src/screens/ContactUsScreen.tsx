...
class ContactUsScreen extends React.Component<Props> {
  ...
  printTest = () => {
    sendDelayedNotification(
      new Date(),
      "Test Notification",
      "When you see it, your setting is good"
    );
  };
  render() {
    return (
          ...
          <SafeAreaView style={styles.container}>
            ...
            >
              ...
              >
                ...
                >
                  <Image
                    source={require("../assets/WellnessCheckLogo.png")}
                    style={{ width: 38, height: 38 }}
                  />
                </TouchableOpacity>
              </View>
              <Title style={styles.title} {...global.panResponder.panHandlers}>
                {resources.getString("contactus_title")}
              </Title>
              <View>
                <View style={styles.content}>
                  ...
                  >
                    {resources.getString("contactus_email")}
                  </Text>
                  <TouchableOpacity
                    onPress={() =>
                      Linking.openURL("mailto:infostats@statcan.gc.ca")
                    }
                  >
                    <Text style={styles.text}>infostats@statcan.gc.ca</Text>
                  </TouchableOpacity>
                </View>
                <View style={styles.content}>
                  <Text
                  ...
                  >
                    {resources.getString("contactus_telephone")}
                  </Text>
                  <TouchableOpacity
                    onPress={() => Linking.openURL("tel:18779499492")}
                  >
                    <Text style={styles.text}>1-877-949-9492</Text>
                  </TouchableOpacity>
                </View>
                <View style={styles.content}>
                  <Text
                  ...
                  >
                    {resources.getString("contactus_website")}
                  </Text>
                  <TouchableOpacity
                ...
                <View style={styles.content}>
                  ...
                  >
                    {resources.getString("contactus_mail")}
                  </Text>
